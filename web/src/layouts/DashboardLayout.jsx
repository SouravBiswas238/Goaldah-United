...
const DashboardLayout = () => {
  ...
  const navItems = [
    ...
    { label: "অর্থ", path: "/finance", icon: DollarSign }, // Added Finance item
    ...(user?.role === "admin"
      ? [
          { label: "সদস্যগণ", path: "/admin/users", icon: Users },
          { label: "ইভেন্ট", path: "/admin/events", icon: Calendar },
        ]
      : [{ label: "ইভেন্ট", path: "/events", icon: Calendar }]),
      ...
      >
        <div className="h-full flex flex-col">
          ...
          <div className="p-4 border-t border-gray-100">
            <Link
              to="/profile"
              className="flex items-center p-4 bg-gray-50 rounded-xl mb-3 hover:bg-gray-100 transition-colors"
            >
